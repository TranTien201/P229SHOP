<div class="main_body">
    <div class="container-fluid">
        <div class="container-fluid mt-4">
            <div class="row">
                <div class="col-12">
                    <h3 class="text-center mt-5 mb-5 text-white">Thêm hình ảnh sản phẩm tương tự</h3>
...
<script>
    $(document).ready(function() {
        ...
        function load_image_data(page) {
            $.ajax({
                url: "<?php echo BASE_URL ?>imgcolor/listimgcolorajax",
                method: "POST",
                data: {
                    page_no: page
                },
        ...
        $('#insert_imgcolor').on('click', function() {
            ...
            if (error_images == '') {
                $.ajax({
                    url: "<?php echo BASE_URL ?>imgcolor/addimgcolor",
                    method: "POST",
                    data: form_data,
                    contentType: false,
                    cache: false,
